<?php /*a:2:{s:54:"E:\PHPTutorial\WWW\wx/themes\pc\mp\material\index.html";i:1531363966;s:60:"E:\PHPTutorial\WWW\wx/themes\pc\mp\..\admin\common\base.html";i:1531363966;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div style="padding: 0px 10px 0px 10px">
    <div class="layui-btn-group" style=" margin-bottom: 5px;">
        ...
        <!--<button onclick="addMaterial()" class="layui-btn layui-btn-danger layui-btn-sm">+ 增加素材</button>-->
    </div>
    <div class="layui-tab">
        ...
        <div class="layui-tab-content">
                ...
                <li class="material_li">
                    <div class="material_li_box">
                        ...
                        <div class="material_li_t">
                            <p><?php echo htmlentities($news['title']); ?></p>
                            <img width="169" height="140" src="<?php echo htmlentities($news['thumb_url']); ?>">
                        </div>
                        <?php else: ?>
                        <div class="material_li_b">
                            <div class="layui-row">
                                ...
                                <div class="layui-col-xs3">
                                    <img width="30" height="30" src="<?php echo htmlentities($news['thumb_url']); ?>">
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="layui-btn-group">
                            <button onclick="sendMaterial('<?php echo htmlentities($v['media_id']); ?>','image')" style="width: 50%" class="layui-btn layui-btn-primary layui-btn-sm">
                                <i class="layui-icon">&#xe609;</i>群发
                            </button>
                            <button onclick="delMaterial('<?php echo htmlentities($v['media_id']); ?>','image')" style="width: 50%;" class="layui-btn layui-btn-primary layui-btn-sm">
            ...
            <table class="layui-table" lay-skin="line">
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($vo['media_id']); ?></td>
                    <td><?php echo htmlentities($vo['create_time']); ?></td>
                    <td>
                        <div class="">
                            <button onclick="delMaterial('<?php echo htmlentities($vo['media_id']); ?>','voice')" class="layui-btn layui-btn-xs layui-btn-danger">
            ...
            <ul class="type_image">
                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <li class="material_li">
                    <span><img src="<?php echo htmlentities($v['url']); ?>" width="169" height="169"></span>
                    <span>
                                <div class="layui-btn-group">
                                  <button onclick="sendMaterial('<?php echo htmlentities($v['media_id']); ?>','image')" style="width: 50%" class="layui-btn layui-btn-primary layui-btn-sm">
                                    <i class="layui-icon">&#xe609;</i>群发
            ...
            <table class="layui-table" lay-skin="line">
                ...
                <tr>
                    ...
                    <td>
                        <div class="">
                            <button onclick="delMaterial('<?php echo htmlentities($vo['media_id']); ?>','video')" class="layui-btn layui-btn-xs layui-btn-danger">
                                <i class="layui-icon">&#xe640;删除</i>
                            </button>
                        </div>
    ...
    function sycMaterial(type) {
        layui.use('layer', function(){
            ...
            layer.open({
                ...
                shade: 0.5,
                area: ['680px', '200px'],
                content: '<?php echo url("mp/Material/sycMaterial","",""); ?>/type/'+type+'/offset/0',
    ...
    function addMaterial() {
        layui.use('layer', function(){
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: "<?php echo url('addMaterial'); ?>"
            });
        });
