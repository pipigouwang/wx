<?php /*a:2:{s:48:"E:\PHPTutorial\WWW\wx/themes\pc\mp\mp\index.html";i:1531363966;s:60:"E:\PHPTutorial\WWW\wx/themes\pc\mp\..\admin\common\base.html";i:1531363966;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                            ...
                            <div class="ui_trendgrid_item">
                                ...
                                <dl>
                                    ...
                                    <dd class="ui_trendgrid_number"><strong><?php echo htmlentities($report['total']['subscribe_total']); ?></strong><em
                                            class="ui_trendgrid_unit"></em></dd>
                                    <dd>累积关注 <i class="icon_up"></i><?php echo htmlentities($report['total']['total']); ?></dd>
                                    <dd>累积取关 <i class="icon_down"></i><?php echo htmlentities($report['total']['unsubscribe_total']); ?></dd>
                                </dl>
                            </div>
                        </td>
                    </tr>
                    ...
                    <div class="layui-colla-item">
                        ...
                        <div class="layui-colla-content layui-show">
                            <ul>
                                ...
                                <li><a href="<?php echo htmlentities($vo['link']); ?>" target="_blank"><?php echo htmlentities($vo['title']); ?></a> </li>
                    ...
                    <div class="layui-colla-item">
                        ...
                        <div class="layui-colla-content layui-show">
                            ...
                            <?php if(is_array($app_by_api) || $app_by_api instanceof \think\Collection || $app_by_api instanceof \think\Paginator): $i = 0; $__LIST__ = $app_by_api;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo htmlentities($vo['link']); ?>" target="_blank" title="<?php echo htmlentities($vo['name']); ?>"><img src="<?php echo htmlentities($vo['logo']); ?>" ><span><?php echo htmlentities($vo['name']); ?></span></a> </li>
                            <?php endforeach; endif; else: echo "暂时没有数据" ;endif; ?>
                            </ul>
                        </div>
                    </div>
