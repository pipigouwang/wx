<?php /*a:2:{s:52:"E:\PHPTutorial\WWW\wx/themes\pc\mp\mp\mpsetting.html";i:1531363966;s:60:"E:\PHPTutorial\WWW\wx/themes\pc\mp\..\admin\common\base.html";i:1531363966;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
    <ul class="layui-tab-title">
        ...
        <li <?php if($type == 'uploadjsfile'): ?>class="layui-this"<?php endif; ?>><a href="<?php echo url('mp/Mp/mpsetting',['type'=>'uploadjsfile']); ?>">上传验证文件</a></li>
    ...
    <div class="layui-tab-content">
        ...
        <form class="layui-form" action="">
            <blockquote class="layui-elem-quote">
                支付授权目录: <?php echo htmlentities($payUrl); ?>
            </blockquote>
