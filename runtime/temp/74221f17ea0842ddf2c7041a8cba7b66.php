<?php /*a:3:{s:50:"E:\PHPTutorial\WWW\wx/themes\pc\mp\mp\special.html";i:1531363966;s:60:"E:\PHPTutorial\WWW\wx/themes\pc\mp\..\admin\common\base.html";i:1531363966;s:61:"E:\PHPTutorial\WWW\wx/themes\pc\mp\common\autoreplay_nav.html";i:1531363966;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="layui-form" action="">
    ...
    <div id="tapNodesubscribe">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="subscribe_keyword" value="<?php echo htmlentities($subscribe['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="subscribe_addons">
                ...
                <option <?php if($subscribe['addon'] == $v['addon']): ?> selected <?php endif; ?>  value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div id="tapNodeunsubscribe">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"></label>
            <div class="layui-input-block">
                <input type="text" name="unsubscribe_keyword" value="<?php echo htmlentities($unsubscribe['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="unsubscribe_addons">
                <option value="">请选择应用</option>
                <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <option <?php if($unsubscribe['addon'] == $v['addon']): ?> selected <?php endif; ?>  value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
        ...
        <div class="layui-tab-content image">
            ...
            <div class="image_keyword layui-tab-item <?php if(!(empty($image['keyword']) || (($image['keyword'] instanceof \think\Collection || $image['keyword'] instanceof \think\Paginator ) && $image['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="image_keyword" value="<?php echo htmlentities($image['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="image_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($image['addon'] == $v['addon']): ?> selected <?php endif; ?>  value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-tab-content voice">
            ...
            <div class="voice_keyword layui-tab-item <?php if(!(empty($voice['keyword']) || (($voice['keyword'] instanceof \think\Collection || $voice['keyword'] instanceof \think\Paginator ) && $voice['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="voice_keyword" value="<?php echo htmlentities($voice['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="voice_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($voice['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-tab-content video">
            ...
            <div class="video_keyword layui-tab-item <?php if(!(empty($video['keyword']) || (($video['keyword'] instanceof \think\Collection || $video['keyword'] instanceof \think\Paginator ) && $video['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="video_keyword" value="<?php echo htmlentities($video['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="video_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($video['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-tab-content shortvideo">
            ...
            <div class="shortvideo_keyword layui-tab-item <?php if(!(empty($shortvideo['keyword']) || (($shortvideo['keyword'] instanceof \think\Collection || $shortvideo['keyword'] instanceof \think\Paginator ) && $shortvideo['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="shortvideo_keyword" value="<?php echo htmlentities($shortvideo['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="shortvideo_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($shortvideo['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-tab-content location">
            ...
            <div class="location_keyword layui-tab-item <?php if(!(empty($location['keyword']) || (($location['keyword'] instanceof \think\Collection || $location['keyword'] instanceof \think\Paginator ) && $location['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="location_keyword" value="<?php echo htmlentities($location['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="location_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($location['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-tab-content event_location">
            ...
            <div class="event_location_keyword layui-tab-item <?php if(!(empty($event_location['keyword']) || (($event_location['keyword'] instanceof \think\Collection || $event_location['keyword'] instanceof \think\Paginator ) && $event_location['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="event_location_keyword"  value="<?php echo htmlentities($event_location['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="event_location_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($event_location['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-tab-content link">
            ...
            <div class="link_keyword layui-tab-item <?php if(!(empty($link['keyword']) || (($link['keyword'] instanceof \think\Collection || $link['keyword'] instanceof \think\Paginator ) && $link['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="link_keyword" value="<?php echo htmlentities($link['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="link_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($link['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-tab-content view">
            ...
            <div class="view_keyword layui-tab-item <?php if(!(empty($view['keyword']) || (($view['keyword'] instanceof \think\Collection || $view['keyword'] instanceof \think\Paginator ) && $view['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <input type="text" name="view_keyword" value="<?php echo htmlentities($view['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="view_addons">
                            <option value="">请选择应用</option>
                            <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option <?php if($view['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">未被识别</label>
        <div id="replyType_unidentified" class="layui-input-block">
            <input type="radio"  <?php if($unidentified['event'] == 'nocol'): ?> checked <?php endif; ?> name="unidentified" value="nocol" title="转客服">
            <input type="radio" <?php if(!(empty($unidentified['keyword']) || (($unidentified['keyword'] instanceof \think\Collection || $unidentified['keyword'] instanceof \think\Paginator ) && $unidentified['keyword']->isEmpty()))): ?> checked <?php endif; ?> name="unidentified" value="keyword" title="触发关键词" >
            <input type="radio" <?php if(!(empty($unidentified['addon']) || (($unidentified['addon'] instanceof \think\Collection || $unidentified['addon'] instanceof \think\Paginator ) && $unidentified['addon']->isEmpty()))): ?> checked <?php endif; ?> name="unidentified" value="addon" title="触发应用">
        </div>
    </div>
    <div id="tapNodeunidentified">
        <div class="layui-tab-content link">
            <div class=" image_text layui-tab-item <?php if($unidentified['event'] == 'nocol'): ?> layui-show <?php endif; ?>">
            <div class="layui-form-item layui-form-text">
            </div>
        </div>
        <div class="unidentified_keyword layui-tab-item <?php if(!(empty($unidentified['keyword']) || (($unidentified['keyword'] instanceof \think\Collection || $unidentified['keyword'] instanceof \think\Paginator ) && $unidentified['keyword']->isEmpty()))): ?> layui-show <?php endif; ?>">
        <div class="layui-form-item">
            <label class="layui-form-label"></label>
            <div class="layui-input-block">
                <input type="text" name="unidentified_keyword" value="<?php echo htmlentities($unidentified['keyword']); ?>" placeholder="请输入关键词" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="unidentified_addon layui-tab-item <?php if(!(empty($unidentified['addon']) || (($unidentified['addon'] instanceof \think\Collection || $unidentified['addon'] instanceof \think\Paginator ) && $unidentified['addon']->isEmpty()))): ?> layui-show <?php endif; ?>">
    <div class="layui-form-item">
        <label class="layui-form-label"></label>
        <div class="layui-input-block">
            <select name="unidentified_addons">
                <option value="">请选择应用</option>
                <?php if(is_array($addons) || $addons instanceof \think\Collection || $addons instanceof \think\Paginator): $i = 0; $__LIST__ = $addons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <option <?php if($unidentified['addon'] == $v['addon']): ?> selected <?php endif; ?> value="<?php echo htmlentities($v['addon']); ?>"><?php echo htmlentities($v['name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
...
<script>
    $(function () {
        ...
        $("#replyType_unidentified").click(function(){
            var class_a='unidentified_'+ $("input[name='unidentified']:checked").val();
            $('.link div').removeClass('layui-show')
            $('.'+class_a).addClass('layui-show')
        });
    })
