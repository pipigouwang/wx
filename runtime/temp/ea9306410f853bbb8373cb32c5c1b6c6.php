<?php /*a:2:{s:47:"E:\PHPTutorial\WWW\wx/themes\pc\mp\mp\menu.html";i:1531363966;s:60:"E:\PHPTutorial\WWW\wx/themes\pc\mp\..\admin\common\base.html";i:1531363966;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="/public/static/admin/css/console.css" />
...
<div class="mp-menu">
    <div class='mobile-preview pull-left'>
        <div class='mobile-header'><?php echo htmlentities($mpInfo['name']); ?></div>
        <div class='mobile-body'></div>
        <ul class='mobile-footer'>
            <?php foreach($list as $menu): ?>
            <li class="parent-menu">
                <a><i class="icon-sub hide"></i> <span data-type="<?php echo htmlentities($menu['type']); ?>" data-content="<?php echo htmlentities($menu['content']); ?>"><?php echo htmlentities($menu['name']); ?></span></a>
                <div class="sub-menu text-center hide">
                    <ul>
                        <?php if(empty($menu['sub']) == false): foreach($menu['sub'] as $submenu): ?>
                        <li>
                            <a class="bottom-border"><span data-type="<?php echo htmlentities($submenu['type']); ?>" data-content="<?php echo htmlentities($submenu['content']); ?>"><?php echo htmlentities($submenu['name']); ?></span></a>
                        </li>
