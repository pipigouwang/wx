<?php /*a:2:{s:63:"E:\PHPTutorial\WWW\wx/application/install\view\index\check.html";i:1531363966;s:63:"E:\PHPTutorial\WWW\wx/application/install\view\public\base.html";i:1531363966;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
		...
		<tbody>
			<?php if(is_array($env) || $env instanceof \think\Collection || $env instanceof \think\Paginator): $i = 0; $__LIST__ = $env;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
				<tr>
					...
					<td style="color: <?php if($item[4] == 'error'): ?>red<?php endif; ?>"><i class="icon icon-<?php echo htmlentities($item[4]); ?>">&nbsp;</i><?php echo htmlentities($item[3]); ?></td>
				</tr>
		...
		<tbody>
			<?php if(is_array($dirfile) || $dirfile instanceof \think\Collection || $dirfile instanceof \think\Paginator): $i = 0; $__LIST__ = $dirfile;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
				<tr>
					...
					<td style="color: <?php if($item[2] == 'error'): ?>red<?php endif; ?>"><i class="icon icon-<?php echo htmlentities($item[2]); ?>">&nbsp;</i><?php echo htmlentities($item[1]); ?></td>
				</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</tbody>
	</table>
